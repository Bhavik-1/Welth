...
const handleScanComplete = (scannedData) => {
  if (scannedData) {
    ...
    if (scannedData.category) {
      // Match scanned category name to category ID
      ...
      if (matchedCategory) {
        ...
        toast.warning("Scanned category not found, please select manually");
      }
    }
      ...
      >
        ...
        <SelectContent>
          ...
          <CreateAccountDrawer>
            <Button
              variant="ghost"
              className="relative w-full py-1.5 text-sm text-left"
            >
              + Create Account
            </Button>
          </CreateAccountDrawer>
